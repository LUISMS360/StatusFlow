...
Route::get('/statusflow/asignar-tarea/{usuario}',GestionarUserEquipo::class)->name('user.asignar.tarea')->middleware('auth');
Route::get('/statusflow/mi-espacio',MiEspacio::class)->name('mi.espacio')->middleware('auth');
